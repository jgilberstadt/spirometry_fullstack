...
public class UrlConfig {
    ...
    static String URL_CHECK_FILE_EXIST = "https://hstest.wustl.edu/spirometry/check_upload.php";
    static String URL_CHECK_PATIENT_EXIST = "https://hstest.wustl.edu/spirometry/login.php";
}
