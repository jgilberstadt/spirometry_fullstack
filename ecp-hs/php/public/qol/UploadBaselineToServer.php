...
error_log("UploadBaselineToServer.php called");
...
echo "There was an error uploading the file, please try again!";
	...
	$insert_id = $db->storeBaselineRecords($title_line[59], $title_line[60], $title_line[61], $title_line[62], $title_line[63], $title_line[64], $title_line[65],
	...
	$ans_array_nonencrypt = array('survey_answer_counter'=>$insert_id, 'q1'=>$title_line[0], 
		'q2'=>$title_line[1],
	...
	$db->storeToFullBaselineTable($ans_array_nonencrypt);
